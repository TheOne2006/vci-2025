...
target("assets")
    ...
    after_build(function (target)
        ...
        os.cp("assets/*|shaders|data", path.join(target:targetdir(), "assets"))
        os.mkdir(path.join(target:targetdir(), "assets", "shaders"))
        os.cp("assets/shaders/*", path.join(target:targetdir(), "assets", "shaders"))
        os.mkdir(path.join(target:targetdir(), "assets", "data"))
        os.cp("assets/data/*", path.join(target:targetdir(), "assets", "data"))
    end)
    after_install(function (target)
        os.mkdir(path.join(target:installdir(), "assets"))
        os.cp("assets/*|shaders|data", path.join(target:installdir(), "assets"))
        os.mkdir(path.join(target:installdir(), "assets", "shaders"))
        os.cp("assets/shaders/*", path.join(target:installdir(), "assets", "shaders"))
        os.mkdir(path.join(target:installdir(), "assets", "data"))
        os.cp("assets/data/*", path.join(target:installdir(), "assets", "data"))
    end)
