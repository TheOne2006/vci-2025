...
target("motion-matching")
    ...
    add_files      ("src/VCX/Labs/MotionMatching/*.cpp|test.cpp")
    add_headerfiles("src/VCX/Labs/MotionMatching/Core/**/*.h")
    add_headerfiles("src/VCX/Labs/MotionMatching/Core/**/*.hpp")
    add_files      ("src/VCX/Labs/MotionMatching/Core/**/*.cpp")

target("motion-matching-test")
    set_kind("binary")
    add_deps("lab-common")
    add_headerfiles("src/VCX/Labs/MotionMatching/*.h")
    add_files      ("src/VCX/Labs/MotionMatching/*.cpp|main.cpp")
    add_headerfiles("src/VCX/Labs/MotionMatching/Core/**/*.h")
    add_headerfiles("src/VCX/Labs/MotionMatching/Core/**/*.hpp")
    add_files      ("src/VCX/Labs/MotionMatching/Core/**/*.cpp")
