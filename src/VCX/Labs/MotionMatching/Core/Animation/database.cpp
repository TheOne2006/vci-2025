...
namespace VCX::Labs::MotionMatching::Core::Animation {
    ...
    void database_build_matching_features(
        ...
        int offset = 0;
        compute_bone_position_feature(db, offset, Animation::Bone_LeftFoot, feature_weight_foot_position);
        compute_bone_position_feature(db, offset, Animation::Bone_RightFoot, feature_weight_foot_position);
        compute_bone_velocity_feature(db, offset, Animation::Bone_LeftFoot, feature_weight_foot_velocity);
        compute_bone_velocity_feature(db, offset, Animation::Bone_RightFoot, feature_weight_foot_velocity);
        compute_bone_velocity_feature(db, offset, Animation::Bone_Hips, feature_weight_hip_velocity);
